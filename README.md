...
Flask web app with 12 detection templates, inline help tooltips, PCRE flag checkboxes, HTTP URI content matching, rule validation, and .rules file import/export. Dark-themed UI with amber labels and real-time live preview. v1.1.0.                                         `Python` `Flask` `Snort` `IDS/IPS` `Network Security`
